...
[_RGB] = LAYOUT_planck_grid(
    ...
    _______, RGB_SAI, RGB_SAD, _______, _______, _______, _______, _______, _______, _______, KC_UP,   _______,
    _______, RGB_VAI, RGB_VAD, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_SPACE] = LAYOUT_planck_grid(
    LOCKOSX, _______, _______, _______, _______, _______, _______, KC_P7, KC_P8, KC_P9,   KC_PMNS, KC_BSPC,
